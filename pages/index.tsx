      ...
      <main>
        <div className="flex flex-col">
          ...
          <div className={`flex flex-1`}>
            <div className='z-50'>
              {/* // Mobile */}
              <div className={`${!open ? 'hidden' : 'block'} fixed bg-white h-full w-full z-10 md:hidden duration-300`} style={{top: '0'}}>
                  ...
                  <div className="flex flex-col justify-between flex-1 h-full px-4">
                    <div className="space-y-4">
                      <nav className="flex-1 space-y-1">
                        <button onClick={() => { setOpen(false) }} title="" className="flex items-center px-1.5 text-sm font-medium transition-all duration-200 text-gray-900 rounded-lg hover:bg-gray-200 group">
